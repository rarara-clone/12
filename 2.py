...
# Danh sách 9 API proxy không phải GitHub
API_SOURCES = [
...
HTTP_OUTPUT = "http.txt"
HTTPS_OUTPUT = "https.txt"
live_http = 0
live_https = 0
checked = 0
total = 0
...
if __name__ == "__main__":
    ...
    print(f"\n\n✅ Kết thúc.")
    print(f"💾 Proxy HTTP sống lưu vào: {HTTP_OUTPUT}")
    print(f"💾 Proxy HTTPS sống lưu vào: {HTTPS_OUTPUT}")
